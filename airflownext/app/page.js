                    ...
                    <div className="main-menu-two__wrapper-inner">
                        <div className="main-menu-two__left">
                            <div className="main-menu-two__logo">
                                <Link href="/"><Image src="/assets/images/resources/logo-2.png" alt="Air Flow Hvac System" fill
        priority/></Link>
                            </div>
                                ...
                                <div className="col-xl-12">
                                    <div className="main-slider-two__content">
                                        ...
                                        <div className="main-slider-two__btn-box">
                                            <Link href="#" className="thm-btn main-slider-two__btn"> Discover more</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-xl-12">
                                    <div className="main-slider-two__content">
                                        <p className="main-slider-two__sub-title">We are all part of a shared world</p>
                                        <h2 className="main-slider-two__title">FOR THE WORLD WE SHARE</h2>
                                        <div className="main-slider-two__btn-box">
                                            <Link href="#" className="thm-btn main-slider-two__btn"> Discover more</Link>
                                        </div>
                                    </div>
                    ...
                    <div className="swiper-slide">
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-xl-12">
                                    <div className="main-slider-two__content">
                                        <p className="main-slider-two__sub-title">HVAC Systems</p>
                                        <h2 className="main-slider-two__title">HVAC is highly vital to worldwide infrastructure</h2>
                                        <div className="main-slider-two__btn-box">
                                            <Link href="#" className="thm-btn main-slider-two__btn"> Discover more</Link>
                                        </div>
                                    </div>
                    ...
                    <div className="swiper-slide">
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-xl-12">
                                    <div className="main-slider-two__content">
                                        <p className="main-slider-two__sub-title">TICA is a professional company</p>
                                        <h2 className="main-slider-two__title">Integrating R&D, manufacture, sales and service</h2>
                                        <div className="main-slider-two__btn-box">
                                            <Link href="#" className="thm-btn main-slider-two__btn"> Discover more</Link>
                                        </div>
                                    </div>
                    ...
                    <div className="swiper-slide">
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-xl-12">
                                    <div className="main-slider-two__content">
                                        <p className="main-slider-two__sub-title">Building the future</p>
                                        <h2 className="main-slider-two__title">For Air Distribution System</h2>
                                        <div className="main-slider-two__btn-box">
                                            <Link href="#" className="thm-btn main-slider-two__btn"> Discover more</Link>
                                        </div>
                                    </div>
                        ...
                        <div className="about-two__left">
                            <div className="about-two__img-box  wow slideInLeft" data-wow-delay="100ms"
                                ...
                                <div className="about-two__img">
                                    <Image src="/assets/images/resources/about-two-img-1.jpg" alt="" fill priority/>
                                </div>
                                <div className="about-two__img-two">
                                    <Image src="/assets/images/resources/about-two-img-2.jpg" alt="" fill priority/>
                                </div>
                                ...
                                <div className="about-two__shape-1 zoominout">
                                    <Image src="/assets/images/shapes/about-two-shape-1.png" alt="" fill priority/>
                                </div>
                                <div className="about-two__shape-2 rotate-me">
                                    <Image src="/assets/images/shapes/about-two-shape-2.png" alt="" fill priority/>
                                </div>
                                <div className="about-two__shape-3 float-bob-y">
                                    <Image src="/assets/images/shapes/about-two-shape-3.png" alt="" fill priority/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="col-xl-6">
                        <div className="about-two__right">
                            ...
                            <p>We specialize in the design, installation, maintenance, and repair of HVAC systems for residential, commercial, and </p>
                                <Link href="about.html" className="thm-btn about-two__btn">Discover More</Link>
